...
def run(
        ...
        vid_stride=0.1,  # video frame-rate stride
        retina_masks=False,
):
    ...
    for frame_idx, batch in enumerate(dataset):
        ...
        # print("PREDICT BOUDING BOX IN ....................", preds)
        # Apply NMS
        with dt[2]:
            if is_seg:
                masks = []
        ...
        for i, det in enumerate(p):  # detections per image
            ...
            if webcam:  # bs >= 1
                ...
                # folder with imgs
                    ...
                    print("*************SAVEEEE PATHHH*******",save_path)
            curr_frames[i] = im0
            # cv2.imshow("dectect car",im0)
            # cv2.waitKey(0)
...
def parse_opt():
    ...
    parser.add_argument('--tracking-method', type=str, default='deepocsort', help='deepocsort, botsort, , ocsort, bytetrack')
